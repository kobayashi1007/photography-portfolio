document.addEventListener("DOMContentLoaded", () => {
  ...
  // 檢測當前路徑，自動調整資源路徑
  const isRoot = window.location.pathname === '/' || window.location.pathname.endsWith('/index.html') || window.location.pathname.endsWith('index.html');
  const imagePrefix = isRoot ? 'image/' : '../image/';
  const linkPrefix = isRoot ? 'html/' : '';

  // 照片與文字資料
  const gallery = [
    {
      img: imagePrefix + "photo1.jpg",
      title: "風景攝影",
      ...
      link: linkPrefix + "viewphoto.html"
    },
    {
      img: imagePrefix + "photo2.jpg",
      title: "人像攝影",
      ...
      link: linkPrefix + "peoplephoto.html"
    },
    {
      img: imagePrefix + "photo3.jpg",
      title: "街拍攝影",
      ...
      link: linkPrefix + "streetphoto.html"
    }
  ];
